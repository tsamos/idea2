...
const testimonials = [{
	text: 'Απόλυτη κατάρτιση αυξημένος επαγγελματισμός ότι καλύτερο στο χώρο 5 αστέρια ανεπιφύλαχτα.',
	name: 'Α.Α.',
	color: 'rgba(235, 59, 90,1.0)'
},{
	text: 'Αξιόπιστοι συνεργάτες. Άψογοι επαγγελματίες.',
	name: 'C.P.G.',
	color: 'rgba(250, 130, 49,1.0)'
},{
	text: 'Σωστοί επαγγελματιες! Πολύ καλή δουλειά!',
	name: 'Γιαννης Π.',
	color: 'rgba(75, 123, 236,1.0)'
},{
	text: 'Ιδιαίτερη και προσεγμένη δουλειά.',
	name: 'Γιώργος Μ.',
	color: 'rgba(165, 94, 234,1.0)'
},{
	text: 'Εξαιρετική ποιότητα δουλειάς, με ιδιαίτερη προσοχή στην λεπτομέρεια, και συνέπεια στους χρόνους παράδοσης! Πάνω από όλα όμως, εξαιρετικοί συνεργάτες!',
	name: 'Κατερίνα Σ.',
